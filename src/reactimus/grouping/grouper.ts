import type { GscRawRow, QueryGroup, QueryVariant } from '../types';
import { contentSignature, tokenise } from '../text/normalise';
import { FUNCTION_WORDS } from '../config/defaults';
